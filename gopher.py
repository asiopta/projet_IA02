...
@memoize
def alphabeta_action_gopher(state: State, tour: Player, alpha=-100, beta=100) -> tuple[float, ActionGopher]:
...
@memoize
def alphabeta_action_gopher_depth(state: State, tour: Player, alpha=-100, beta=100) -> tuple[float, ActionGopher]:
